...
export class CierreMensualGuiado1785481200000 implements MigrationInterface {
  name = 'CierreMensualGuiado1785481200000';
  ...
  public async down(): Promise<void> {
    // No destructiva: revisiones y eventos son evidencia contable.
  }
}
