...
export class Oportunidad {
  ...
  prospecto?: Prospecto;
  @Column({ type: 'uniqueidentifier', nullable: true }) prospectoId?: string;
...
export class Actividad {
  ...
  @Column({ type: 'datetime2' }) fechaProgramada!: Date;
  @Column({ type: 'datetime2', nullable: true }) fechaRealizada?: Date;
