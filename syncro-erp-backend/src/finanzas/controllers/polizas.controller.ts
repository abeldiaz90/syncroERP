...
export class PolizasController {
    ...
    @Post()
    crear(@Body() dto: CrearPolizaDto, @ActiveUser('empresaId') empresaId: string) {
    ...
    @Navegable('/dashboard/finanzas/estado-resultados', 'Estado de Resultados', 53)
    @Get('resultado')
    obtenerEstadoResultados(
        ...
        return this.polizasService.obtenerBalanzaComprobacion(empresaId, fechaDesde, fechaHasta);
    }
    ...
    obtenerDeclaracionIVA(
        ...
        return this.polizasService.obtenerDeclaracionIVA(empresaId, fechaDesde, fechaHasta);
    }
    ...
    obtenerBalance(
        ...
        return this.polizasService.obtenerBalanzaComprobacion(empresaId, undefined, fechaHasta);
    }
  ...
  getSaldosIniciales() {
    return { mensaje: 'Usa POST /manual con concepto "Saldos iniciales de apertura"' };
  }
