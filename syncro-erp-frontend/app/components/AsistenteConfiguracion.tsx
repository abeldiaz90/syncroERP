...
const PASOS: PasoDef[] = [
  ...
  {
    clave: 'cuentas',
    titulo: 'Configurar cuentas contables',
    descripcion: 'El motor contable las usa para registrar cada venta y compra.',
    endpoint: '/finanzas/cuentas-contables',
    completoSi: (d) => Array.isArray(d) && d.length > 0,
    ruta: '/dashboard/finanzas/cuentas-contables',
  ...
  },
  {
    ...
    descripcion: 'IVA 16%, IVA 0%, Exento… se aplican a tus productos y son obligatorios.',
    endpoint: '/catalogo/impuestos',
    completoSi: (d) => Array.isArray(d) && d.length > 0,
    ruta: '/dashboard/impuestos',
    textoBoton: 'Configurar impuestos',
  },
  {
    clave: 'marcas',
