...
export default function CarteraVencidaPage() {
  ...
  const totalGeneral = cartera ? Object.values(cartera).reduce((s,b)=>s+totalBucket(b as IAgingItem[]), 0) : 0;
    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">{cartera?Object.values(cartera).reduce((s,b)=>s+b.length,0):0} cuotas</p>
        </div>
