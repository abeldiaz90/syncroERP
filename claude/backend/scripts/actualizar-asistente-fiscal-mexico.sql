/*
  Asistente fiscal México — actualización manual para SQL Server.
  Es idempotente. Respaldar la base antes de ejecutarlo.
*/
SET XACT_ABORT ON;
BEGIN TRANSACTION;
