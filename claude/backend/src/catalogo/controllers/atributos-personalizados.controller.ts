...
import { ActualizarDefinicionAtributoDto, ActualizarGrupoAtributoDto, CrearDefinicionAtributoDto, CrearGrupoAtributoDto } from '../dto/catalogo-operaciones.dto';
...
export class AtributosPersonalizadosController {
  ...
  crearGrupo(
    @ActiveUser('empresaId') empresaId: string,
    @Body() dto: CrearGrupoAtributoDto,
  ) {
  ...
  actualizarGrupo(
    @ActiveUser('empresaId') empresaId: string,
    @Param('id') id: string,
    @Body() dto: ActualizarGrupoAtributoDto,
  ) {
  ...
  crearDefinicion(
    ...
    @Body() dto: CrearDefinicionAtributoDto,
  ) {
  ...
  actualizarDefinicion(
    @ActiveUser('empresaId') empresaId: string,
    @Param('id') id: string,
    @Body() dto: ActualizarDefinicionAtributoDto,
  ) {
