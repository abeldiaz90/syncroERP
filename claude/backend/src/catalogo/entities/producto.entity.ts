...
export class Producto {
   ...
   */
  @Column({ type: 'decimal', transformer: decimalNumberTransformer, precision: 18, scale: 4, nullable: true })
  ...
  @Column({ type: 'decimal', transformer: decimalNumberTransformer, precision: 5, scale: 1, nullable: true })
  ...
  @Column({ type: 'decimal', transformer: decimalNumberTransformer, precision: 10, scale: 3, nullable: true })
  pesoKg!: number;

  @Column({ type: 'decimal', transformer: decimalNumberTransformer, precision: 10, scale: 2, nullable: true })
  volumenCm3!: number;
