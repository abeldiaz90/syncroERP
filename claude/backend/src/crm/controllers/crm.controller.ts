...
export class CrmController {
  ...
  crearOportunidad(
    ...
    return this.svc.crearOportunidad(
      {
        ...dto,
        fechaCierreEstimada: dto.fechaCierreEstimada
          ? new Date(dto.fechaCierreEstimada)
          : undefined,
      },
      empresaId,
    );
  ...
  crearActividad(
    ...
    return this.svc.crearActividad(
      { ...dto, fechaProgramada: new Date(dto.fechaProgramada) },
      empresaId,
    );
  }
  ...
  completar(
    @Param('id') id: string,
    @Body() body: CompletarActividadDto,
    @ActiveUser('empresaId') empresaId: string,
  ) {
