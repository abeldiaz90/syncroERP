...
import {
  htmlConfirmacionVenta,
  htmlCreditoOtorgado,
  htmlRecordatorioCuota,
  htmlCuotaVencida,
  htmlOrdenCompraProveedor,
  htmlStockBajo,
  htmlBienvenidaUsuario,
...
export class NotificacionesService {
  ...
  // 2. CRÉDITO OTORGADO
  // ══════════════════════════════════════════════════════════════════════════
  async notificarCreditoOtorgado(
    venta: any,
    credito: any,
    cliente?: any,
  ): Promise<void> {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  async notificarRecordatorioCuota(
    cuota: any,
    credito: any,
    cliente?: any,
  ): Promise<void> {
